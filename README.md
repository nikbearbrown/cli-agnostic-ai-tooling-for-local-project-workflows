...
- `images/cli-agnostic-ai-tooling-for-local-project-workflows-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/cli-agnostic-ai-tooling-for-local-project-workflows-fig-NN.html` — interactive D3 HTML
